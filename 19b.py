...
while scanners:
    ...
    scanner_posses.append(pos)

max_distance = 0
for scanner_1, scanner_2 in permutations(scanner_posses, 2):
    distance = sum((
        abs(scanner_1.x - scanner_2.x),
        abs(scanner_1.y - scanner_2.y),
        abs(scanner_1.z - scanner_2.z)
    ))
